...
class CustomerWatchlistController extends Controller
{
    use HasResourceActions;

    static $header_title = '商品收藏清單管理';
    ...
    {
        $grid = new Grid(new CustomerWatchlist);
    ...
    {
        $show = new Show(CustomerWatchlist::findOrFail($id));
    ...
    {
        $form = new Form(new CustomerWatchlist);
